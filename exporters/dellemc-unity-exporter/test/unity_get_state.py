...
# Create log-object
LOG_FILENAME = "C:\\Temp\\unity_state.log"
...
if __name__ == "__main__":
	...
	'''
list_resources = ['battery', 'ssd', 'ethernetPort', 'fcPort', 'sasPort', 'fan', 'powerSupply', 'storageProcessor', 'lun', 'pool', 'dae', 'dpe', 'ioModule', 'lcc', 'memoryModule', 'ssc', 'uncommittedPort', 'disk']
#discovering_resources('zabbix', 'ZC2FpATav%(%B', '192.168.253.101', '443', ' unity480-g1u3', list_resources)
get_status_resources('zabbix', 'ZC2FpATav%(%B', '192.168.253.101', '443', ' unity480-g1u3', list_resources)
