        ...
        for hostname, hostdata in restic_clients.items():
            ...
            try:
                ...
                if hostdata['backup_type'] == 'psql':
                    ...
                    init_restic_repo()
                    run_backup_streamed(hostdata['host_name'], hostdata['host_ip'], hostdata['ssh_user'], hostdata['ssh_port'], hostdata['postgresql_user'], hostdata['postgresql_port'])
        ...
        if selected_host:
            ...
            try:
                ...
                if selected_host['backup_type'] == 'psql':
                    ...
                    init_restic_repo()
                    run_backup_streamed(selected_host['host_name'], selected_host['host_ip'], selected_host['ssh_user'], selected_host['ssh_port'], selected_host['postgresql_user'], selected_host['postgresql_port'])
