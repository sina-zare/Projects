...
mra_vms = [vm for vm in mra_vm_view.view if (vm.name.startswith("RA-") and not vm.name.startswith("RA-Amini") and not vm.name.startswith("RA-MISTest") and not vm.name.startswith("RA-Mistest") )]
