...
ME_VC = connect.SmartConnect(host='me-vc01.abramad.com',user= 'sina.z@abramad.com',pwd= os.environ.get('spass'),port=443,sslContext=context)
...
if len(noisy_vms) >= 1:
    if error_log == "":
        ...
        smtp_password = os.environ.get('spass')
