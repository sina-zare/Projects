...
symbol = "XAUUSD"
timeframe = mt5.TIMEFRAME_M15  # 15 Mins timeframe
...
def monitor_candles():
    while True:
        ...
        if is_pin_bar(last_candle):
            ...
            body = f"<b>{today_date_jalali_full}</b><br><br>Symbol: <b>{symbol}</b><br>Time Frame: 15M<br>Pin Bar Pattern Formed on <b>{symbol}</b> at <b>{shamsi_time}</b><br>Consider Buy/Sell Opportunities.<br><br>Cheers"
            email_sender(username, password, "soroush.theeee1st@gmail.com", "",
                         f"Pin Bar Formed | {shamsi_date} | 15M", "ltr", body,
