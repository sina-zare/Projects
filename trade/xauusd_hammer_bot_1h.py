try:
    ...
    # Symbol Info
    log_path = "xauusd_hammer_1h.log"
    image_path = "xauusd_hammer_1h.png"
    symbol = "XAUUSD"
    ...
    def generate_chart(candles):
        ...
        mpf.plot(df, type='candle', style='charles', title=f'{symbol} 1-Hour Candlesticks', ylabel='Price',
                    ...
                    if bars is not None and bars.size > 0:
                        ...
                        if os.path.exists(image_path) and os.path.getsize(image_path) > 0:
                            ...
                            if is_perfect_hammer(last_candle):
                                ...
                                print(10 * '~' + f'{symbol} 1H' + 10 * '~')
                                with open(log_path, "a") as log:
                                    log.write(10 * '~' + f'{symbol} 1H' + 10 * '~' + "\n")
