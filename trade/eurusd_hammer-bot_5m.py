try:
    ...
    # Symbol Info
    log_path = "eurusd_hammer_5m.log"
    image_path = "eurusd_hammer_5m.png"
    symbol = "EURUSD"
    ...
    def generate_chart(candles):
        ...
        mpf.plot(df, type='candle', style='charles', title=f'{symbol} {timeframe}-Minute Candlesticks',
                 ylabel='Price',
                        ...
                        if is_hammer(last_candle):
                            ...
                            if bars is not None and bars.size > 0:
                                ...
                                if os.path.exists(image_path) and os.path.getsize(image_path) > 0:
                                    ...
                                    shamsi_date, shamsi_time = convert_miladi_to_shamsi(candle_miladi_date,
                                                                                        candle_plus3_00_time)
