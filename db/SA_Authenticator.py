...
def decryptor(enc_env_var, key_env_var):
    try:
        ...
        if os.environ.get(enc_env_var) == None or os.environ.get(key_env_var) == None:
            print("Missing Envs, run the app as Administrator.")
            time.sleep(10)
            sys.exit()
